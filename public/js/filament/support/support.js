(() => {
  ...
  function Mi(e, t, n, r) {
    ...
    return i && typeof b == "number" && (g = i === "end" ? b * -1 : b), s ? {x: g * u, y: m * c} : {x: m * c, y: g * u}
  }
  ...
  var Fo = function (e) {
    ...
    return e === void 0 && (e = {}), {
      name: "size", options: e, async fn(t) {
        let {placement: n, rects: r, platform: o, elements: i} = t, {apply: s, ...c} = e, u = await En(t, c), h = wt(n),
          m = ln(n), g, b;
    ...
    return e === void 0 && (e = {}), {
      name: "inline", options: e, async fn(t) {
        var n;
        let {placement: r, elements: o, rects: i, platform: s, strategy: c} = t, {padding: u = 2, x: h, y: m} = e,
        ...
        function S() {
          ...
          if (b.length >= 2) {
            ...
            let B = wt(r) === "left", L = qt(...b.map(ue => ue.right)), K = Mo(...b.map(ue => ue.left)),
              W = b.filter(ue => B ? ue.left === K : ue.right === L), he = W[0].top, ee = W[W.length - 1].bottom, Z = K,
              de = L, N = de - Z, ae = ee - he;
            return {top: he, bottom: ee, left: Z, right: de, width: N, height: ae, x: Z, y: he}
          }
          return g
        }

        let T = await s.getElementRects({reference: {getBoundingClientRect: S}, floating: o.floating, strategy: c});
  ...
  function ki(e, t, n) {
    let r = Et(t), o = Kt(t), i = Pt(e, r && Ni(t), n === "fixed"), s = {scrollLeft: 0, scrollTop: 0}, c = {x: 0, y: 0};
  ...
  function Hi(e) {
    ...
    let n = Kt(e), r = dr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body,
      ...
      s = jn(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), c = -r.scrollLeft + Uo(e),
      u = -r.scrollTop;
    ...
    [...r, ...o].forEach(i => {
      ...
      async function B() {
        return await To(i, b, h).then(({middlewareData: L, placement: K, x: W, y: he}) => {
          if (L.arrow) {
            let ee = L.arrow?.x, Z = L.arrow?.y, de = h.middleware.filter(ae => ae.name == "arrow")[0].options.element,
    ...
    return {
      captureAnimationState: function () {
        ...
        e.forEach(function (c) {
          var u = 0, h = c.target, m = h.fromRect, g = qe(h), b = h.prevFromRect, O = h.prevToRect, S = c.rect,
            T = Dn(h, !0);
  ...
  var D, $e, oe, Ie, fn, br, Be, Qt, An, at, zn, Jt, pr, Ge, Cn = !1, Or = !1, Sr = [], cn, vt, to, no, ti, ni, $n, Sn,
    Yn, qn = !1, hr = !1, yr, Qe, ro = [], lo = !1, Cr = [], Dr = typeof document < "u", vr = ii,
    ...
    constructor: q, _isOutsideThisEl: function (t) {
      ...
      if (t.cancelable) {
        var n = this, r = this.el, o = this.options, i = o.preventOnFilter, s = t.type,
          c = t.touches && t.touches[0] || t.pointerType && t.pointerType === "touch" && t, u = (c || t).target,
          h = t.target.shadowRoot && (t.path && t.path[0] || t.composedPath && t.composedPath()[0]) || u, m = o.filter;
      ...
      var n = this.el, r = t.target, o, i, s, c = this.options, u = c.group, h = q.active, m = pr === u, g = c.sort,
        b = Ge || h, O, S = this, T = !1;
      if (lo) return;
      ...
      if (Or = !1, h && !c.disabled && (m ? g || (s = $e !== Ie) : Ge === this || (this.lastPutMode = pr.checkPull(this, h, D, t)) && u.checkPut(this, h, D, t))) {
        ...
        if (!W || Da(t, O, this) && !W.animated) {
          ...
          i = qe(r);
          var ee = 0, Z, de = D.parentNode !== n, N = !Ea(D.animated && D.toRect || o, r.animated && r.toRect || i, O),
            ae = O ? "top" : "left", ue = Zo(r, "top", "top") || Zo(D, "top", "top"), Ce = ue ? ue.scrollTop : void 0;
  ...
  function Ta(e, t, n, r, o, i, s, c) {
    var u = r ? e.clientY : e.clientX, h = r ? n.height : n.width, m = r ? n.top : n.left, g = r ? n.bottom : n.right,
      b = !1;
    if (!s) {
      if (c && yr < h * o) {
  ...
  var so = ci(function (e, t, n, r) {
    if (t.scroll) {
      ...
      var g = 0, b = Wn;
      do {
        var O = b, S = qe(O), T = S.top, F = S.bottom, B = S.left, L = S.right, K = S.width, W = S.height, he = void 0,
          ee = void 0, Z = O.scrollWidth, de = O.scrollHeight, N = Y(O), ae = O.scrollLeft, ue = O.scrollTop;
        ...
        (Ue[g].vx != Ce || Ue[g].vy != pe || Ue[g].el !== O) && (Ue[g].el = O, Ue[g].vx = Ce, Ue[g].vy = pe, clearInterval(Ue[g].pid), (Ce != 0 || pe != 0) && (h = !0, Ue[g].pid = setInterval(function () {
          ...
          var We = Ue[this.layer].vy ? Ue[this.layer].vy * c : 0, Le = Ue[this.layer].vx ? Ue[this.layer].vx * c : 0;
  ...
  var Ia = Object.create, mo = Object.defineProperty, La = Object.getPrototypeOf, Na = Object.prototype.hasOwnProperty,
    ka = Object.getOwnPropertyNames, ja = Object.getOwnPropertyDescriptor, Fa = e => mo(e, "__esModule", {value: !0}),
    wi = (e, t) => () => (t || (t = {exports: {}}, e(t.exports, t)), t.exports), Ba = (e, t, n) => {
      ...
      var Z = "top", de = "bottom", N = "right", ae = "left", ue = "auto", Ce = [Z, de, N, ae], pe = "start", ve = "end",
        We = "clippingParents", Le = "viewport", Te = "popper", tt = "reference", Nt = Ce.reduce(function (l, a) {
      ...
      function Ht(l, a) {
        ...
        var d = a, E = d.placement, x = E === void 0 ? l.placement : E, A = d.boundary, R = A === void 0 ? We : A,
          ...
          xe = rr({reference: Se, element: De, strategy: "absolute", placement: x}), Re = Bt(Object.assign({}, De, xe)),
          Pe = I === Te ? Re : Se, Ve = {
      ...
      function mn(l) {
        l === void 0 && (l = {});
        var a = l, d = a.defaultModifiers, E = d === void 0 ? [] : d, x = a.defaultOptions, A = x === void 0 ? gn : x;
            ...
            state: I, setOptions: function (ke) {
              ...
              if (!Me) {
                ...
                for (var J = 0, Se = 0; Se < I.orderedModifiers.length; Se++) {
                  ...
                  var xe = I.orderedModifiers[Se], Re = xe.fn, Pe = xe.options, Ve = Pe === void 0 ? {} : Pe,
                    Fe = xe.name;
                  typeof Re == "function" && (I = Re({state: I, options: Ve, name: Fe, instance: ye}) || I)
                }
              }
            }, update: jt(function () {
      ...
      function In(l) {
        var a, d = l.popper, E = l.popperRect, x = l.placement, A = l.offsets, R = l.position, P = l.gpuAcceleration,
          j = l.adaptive, z = l.roundOffsets, I = z === !0 ? $r(A) : typeof z == "function" ? z(A) : A, Ee = I.x,
          Me = Ee === void 0 ? 0 : Ee, ye = I.y, fe = ye === void 0 ? 0 : ye, Ae = A.hasOwnProperty("x"),
          ge = A.hasOwnProperty("y"), ke = ae, De = Z, je = window;
        if (j) {
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
        var I = {placement: nt(a.placement), popper: a.elements.popper, popperRect: a.rects.popper, gpuAcceleration: x};
      ...
      function Ne(l, a) {
        ...
        var d = a, E = d.placement, x = d.boundary, A = d.rootBoundary, R = d.padding, P = d.flipVariations,
          j = d.allowedAutoPlacements, z = j === void 0 ? dn : j, I = tn(E), Ee = I ? P ? Nt : Nt.filter(function (fe) {
            return tn(fe) === I
      ...
      function _e(l) {
        ...
        if (!a.modifiersData[E]._skip) {
          for (var x = d.mainAxis, A = x === void 0 ? !0 : x, R = d.altAxis, P = R === void 0 ? !0 : R, j = d.fallbackPlacements, z = d.padding, I = d.boundary, Ee = d.rootBoundary, Me = d.altBoundary, ye = d.flipVariations, fe = ye === void 0 ? !0 : ye, Ae = d.allowedAutoPlacements, ge = a.options.placement, ke = nt(ge), De = ke === ge, je = j || (De || !fe ? [te(ge)] : be(ge)), J = [ge].concat(je).reduce(function (V, ie) {
            ...
            var He = J[Fe], ht = nt(He), Je = tn(He) === pe, Dt = [Z, de].indexOf(ht) >= 0, on = Dt ? "width" : "height",
      ...
      function $(l) {
        var a = l.state, d = l.options, E = l.name, x = d.mainAxis, A = x === void 0 ? !0 : x, R = d.altAxis,
          P = R === void 0 ? !1 : R, j = d.boundary, z = d.rootBoundary, I = d.altBoundary, Ee = d.padding, Me = d.tether,
          ye = Me === void 0 ? !0 : Me, fe = d.tetherOffset, Ae = fe === void 0 ? 0 : fe,
          ...
          Ve = typeof Ae == "function" ? Ae(Object.assign({}, a.rects, {placement: a.placement})) : Ae, Fe = {x: 0, y: 0};
        if (xe) {
          if (A || P) {
            var He = J === "y" ? Z : ae, ht = J === "y" ? de : N, Je = J === "y" ? "height" : "width", Dt = xe[J],
              on = xe[J] + ge[He], Ut = xe[J] - ge[ht], Tt = ye ? -Pe[Je] / 2 : 0, Ln = De === pe ? Re[Je] : Pe[Je],
              Xt = De === pe ? -Pe[Je] : -Re[Je], yn = a.elements.arrow, Nn = ye && yn ? T(yn) : {width: 0, height: 0},
              w = a.modifiersData["arrow#persistent"] ? a.modifiersData["arrow#persistent"].padding : or(), H = w[He],
              V = w[ht], ie = re(0, Re[Je], Nn[Je]), ce = je ? Re[Je] / 2 - Tt - ie - H - Ve : Ln - ie - H - Ve,
              ze = je ? -Re[Je] / 2 + Tt + ie + V + Ve : Xt + ie + V + Ve, Ye = a.elements.arrow && ee(a.elements.arrow),
              bt = Ye ? J === "y" ? Ye.clientTop || 0 : Ye.clientLeft || 0 : 0,
              kn = a.modifiersData.offset ? a.modifiersData.offset[a.placement][J] : 0, yt = xe[J] + ce - kn - bt,
              wn = xe[J] + ze - kn;
            if (A) {
            ...
            if (P) {
              var zt = J === "x" ? Z : ae, Wr = J === "x" ? de : N, Yt = xe[Se], sn = Yt + ge[zt], bo = Yt - ge[Wr],
                yo = re(ye ? en(sn, yt) : sn, Yt, ye ? ft(bo, wn) : bo);
      ...
      function Xe(l) {
        ...
        if (!(!A || !R)) {
          var Ee = v(x.padding, d), Me = T(A), ye = j === "y" ? Z : ae, fe = j === "y" ? de : N,
            Ae = d.rects.reference[I] + d.rects.reference[j] - R[j] - d.rects.popper[I], ge = R[j] - d.rects.reference[j],
            ke = ee(A), De = ke ? j === "y" ? ke.clientHeight || 0 : ke.clientWidth || 0 : 0, je = Ae / 2 - ge / 2,
        ...
        function xe() {
          ...
          var w = v.props, H = w.popperOptions, V = w.placement, ie = w.offset, ce = w.getReferenceClientRect,
            ...
            bt = ce ? {getBoundingClientRect: ce, contextElement: ce.contextElement || ot()} : f, kn = {
              name: "$$tippy", enabled: !0, phase: "beforeWrite", requires: ["computeStyles"], fn: function (an) {
                var zt = an.state;
                if (Ze()) {
                  var Wr = rn(), Yt = Wr.box;
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "))
        ...
        function Tt() {
          ...
          var w = v.state.isVisible, H = v.state.isDestroyed, V = !v.state.isEnabled, ie = Te.isTouch && !v.props.touch,
...
`, "2) content: () => element.cloneNode(true)"].join(" "));
      ...
      var Mn = {
        name: "followCursor", defaultValue: !1, fn: function (p) {
          ...
          function Ne(U) {
            var ne = U.target ? y.contains(U.target) : !0, re = p.props.followCursor, $ = U.clientX, X = U.clientY,
              v = y.getBoundingClientRect(), Xe = $ - v.left, Q = X - v.top;
      ...
      function Hr(f, p, y, C) {
        ...
        switch (f) {
          case"top":
          case"bottom": {
            var k = y[0], M = y[y.length - 1], _ = f === "top", se = k.top, G = M.bottom, te = _ ? k.left : M.left,
              le = _ ? k.right : M.right, Oe = le - te, Ne = G - se;
