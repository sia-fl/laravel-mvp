    ...
    (function (h, a) {
      ...
      return function (l) {
        ...
        var nn = function () {
          ...
          }, un = new tt(U({}, Bt, Jt)), hn = new tt(U({}, Xt, Jt)), ln = {ws: cn, xhr_streaming: un, xhr_polling: hn},
          ct = ln, fn = new tt({
            file: "sockjs", urls: Ze, handlesActivityChecks: !0, supportsPing: !1, isSupported: function () {
              return !0
        ...
        var hr = function (e, t, n) {
          ...
          var o = Object.assign({}, t, {
            ...
            k = new Gt({lives: 2, minPingDelay: 1e4, maxPingDelay: e.activityTimeout}), L = i("ws", "ws", 3, o, g),
            X = i("wss", "ws", 3, u, g), fi = i("sockjs", "sockjs", 1, p),
            ne = i("xhr_streaming", "xhr_streaming", 1, p, k), pi = i("xdr_streaming", "xdr_streaming", 1, p, k),
            re = i("xhr_polling", "xhr_polling", 1, p), di = i("xdr_polling", "xdr_polling", 1, p), ie = new Y([L], _),
            vi = new Y([X], _), yi = new Y([fi], _), oe = new Y([new it(ot(ne), ne, pi)], _),
            se = new Y([new it(ot(re), re, di)], _),
            ae = new Y([new it(ot(oe), new wt([oe, new ut(se, {delay: 4e3})]), se)], _), Pt = new it(ot(ae), ae, yi),
            xt;
...
`);
        ...
        var ht = Ct, Nr = function () {
          ...
          return e.prototype.isSupported = function () {
            ...
            var i = !1, o = this.transport.createConnection(this.name, this.priority, this.options.key, this.options),
              u = null, p = function () {
